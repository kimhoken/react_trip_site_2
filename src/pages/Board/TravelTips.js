...
export default function TravelTips(){
    ...
    const checkKey = loginUser ? `travelTips_${loginUser.id}` : ""
    ...
    }, [checked,loginUser,checkKey,loaded]);
    ...
    const toggle=(key)=>{setChecked((prev)=>prev.includes(key)
        ? prev.filter((i) => i !== key) : [...prev, key])
    }

    const totalCnt = Object.values(tips).flat().length;
        ...
        <div className="check-wrap">
            <div className="check-card">
                ...
                <div className="bottom-row">
                    <span>{totalCnt}개 항목 중 {checkedCnt}개 완료</span>
